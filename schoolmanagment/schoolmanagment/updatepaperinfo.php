...
<div class="mb-3">
    ...
    <input type="text" name="paper_title" class="form-control" value="<?= htmlspecialchars($paperData['paper_title'] ?? '') ?>" required>

</div>

<div class="mb-3">
    <label> Paper Date</label>
   <input type="date" name="paper_date" class="form-control" value="<?= htmlspecialchars($paperData['paper_date'] ?? '') ?>" required>

</div>

<div class="mb-3">
    <label> Duration</label>
  <input type="text" name="duration" class="form-control" value="<?= htmlspecialchars($paperData['duration'] ?? '') ?>" required>
